...
// class PricePage extends StatelessWidget {
//   final PricePageController _controller = PricePageController();
//   //Get.delete<HogaPageController>();
//   final HogaPageController _hogaController = HogaPageController();
//   //final HogaPageController _hogaController =  Get.put(HogaPageController());
//
//   //HogaPageController _hogaController =  Get.find<HogaPageController>();
//  // final FavPageController _fevController = FavPageController();
...
//   List selectedJm = [];
//
//   // ever(_fevController.isRushTest.value, _setupWebSocket());
//
//   PricePage(String selectedJmCode, String selectedJmName) {
//     selectedJm = [selectedJmCode, selectedJmName];
//
//     //_hogaController.selectedJm.value = [selectedJmCode, selectedJmName];
//     _requestData(selectedJm[0]);
//
//     //_hogaController.requestData(_hogaController.selectedJm.value[0],_globalCtrl.isRushTest.value);
//
//     _hogaController.requestPRPR(_hogaController.selectedJm.value[0]);
//     _hogaController.requestChe(_hogaController.selectedJm.value[0]);
//     _hogaController.requestHoga(_hogaController.selectedJm.value[0]);
//   }
//
//   void setupWebSocket() async {
//     try {
...
//                          height: hogaListHeight,
//                         child: Obx(() {
//                          // _setupWebSocket(_globalCtrl.isRushTest.value);
//
//                           //ever(_fevController.isRushTest.value, _hogaController.setupWebSocket());
//
//                           if (_hogaController.hoga.value == null) {
//                             print('_hogaController.hoga.value가 null');
//                             return Container();
...
//     var body;
//
//     if(_globalCtrl.isRushTest .value == false) {
//        url = 'http://203.109.30.207:10001/requestReal';
//        body = jsonEncode({
//         'header': {'sessionKey': websocketKey, 'tr_type': '1'},
//         'objCommInput': {"tr_id": "H0STASP0", 'tr_key': jmCode},
